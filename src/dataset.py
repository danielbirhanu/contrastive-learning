...
class ContrastiveDataset(torch.utils.data.Dataset):
    """Returns two augmented views of each image as a positive pair."""
    ...
    def __getitem__(self, idx):
        # Ignore target for self-supervised training, keep for evaluation.
...
def get_transforms(strength="weak"):
    """Returns the MNIST data augmentation pipeline based on strength."""
    if strength == "weak":
        # Weak augmentation: translation/crop
        ...
        # Strong augmentation: resized crop and rotation
        return transforms.Compose([
...
def get_dataloaders(batch_size=128, strength="weak", subset_size=10000):
    """Loads MNIST, wraps in contrastive dataset, and returns sub-sampled dataloaders."""
    ...
    # Load standard MNIST test dataset
